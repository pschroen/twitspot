...
var path = require('path'),
    ...
    api = require((process.env._ !== process.execPath ? '..' : process.cwd())+'/node_modules/node-spotify/build/Release/nodespotify')({
...
process.on('message', function (payload) {
    ...
    switch (message) {
        case 'login':
            ...
            break;
        case 'search':
            var url = 'https://api.spotify.com/v1/search?q='+encodeURIComponent(data.query)+'&type=track&market='+api.sessionUserCountry+'&limit=1';
            debug('search  : '+url);
